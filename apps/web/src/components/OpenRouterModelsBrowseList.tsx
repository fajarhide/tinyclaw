    ...
    <div className={cn("flex flex-col", className)}>
      ...
      <div className="min-h-0 flex-1">
        {isLoading ? (
          ...
          <VirtualOpenRouterModelList rows={filtered} onSelect={onSelect} />
        )}
      </div>
    </div>
  );
...
function VirtualOpenRouterModelList({
  rows,
  onSelect,
}: {
...
function OpenRouterModelRowButton({
  row,
  onSelect,
  style,
}: {
