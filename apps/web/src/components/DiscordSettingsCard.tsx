        ...
        >
          ...
          {!isPaired && pairingCode ? (
            <ol className="list-decimal space-y-1 px-4 py-3 pl-8 text-xs text-muted-foreground">
              <li>Open Discord and DM your bot</li>
              <li>Send the pairing code as a message</li>
              <li>For server channels: complete DM pairing first</li>
              <li>Enable Message Content Intent in the Discord Developer Portal</li>
              <li>Re-invite the bot after changing intents</li>
              <li>In a server, trigger the bot with an @mention, reply, or slash command</li>
            </ol>
          ) : null}
        </div>
      ) : null}
